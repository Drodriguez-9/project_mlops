...
class DataProcessor:
    ...
    def process_data(self, stable=True):
        ...
        self.data.assign(income = LabelEncoder().fit_transform(self.data["income"]),
                    )
        ...
        ], remainder='passthrough')  # 'passthrough' leaves the already encoded categorical columns untouched
